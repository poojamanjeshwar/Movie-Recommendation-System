...
public class NeighbourBasedRatingRecommendation {
	...
	public UserBasedRecommender getRecommender(double threshold) throws TasteException{
	...
	public List<RecommendedItem> getRecommendation(UserBasedRecommender recommender,long userId, int numberOfRecommendation) throws TasteException{
